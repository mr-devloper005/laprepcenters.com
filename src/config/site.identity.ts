export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'laprepcenters',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Laprepcenters',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'laprepcenters.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://laprepcenters.com',
